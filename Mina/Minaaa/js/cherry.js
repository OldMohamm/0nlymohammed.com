(function(){
	...
	var BackgroundColor = "#1e2b58";
	var leafColorDark = "#FFFAFA";
	var leafColorLight = "#FFFAFA"
	var pistileColor = "#6F0011";
	var numOfLeaves = 100;	/*Amount of falling leaves*/
	var numOfFlowers = 50;	/*Amount of flowers*/
